...
namespace WebApplication1.Models
{
    public class Patients
    {
        ...
        public ICollection<porteurCarteSoins>? porteurCarteSoins { get; set; }
        public ICollection<PatientCnam>? patientsCnam { get; set; }
        public ICollection<PatientAyantDroit>? patientsAyantDroits { get; set; }
        public ICollection<PatientBebe>? patientsBebe { get; set; }
        public ICollection<PatientCp>? patientsCp { get; set; }
